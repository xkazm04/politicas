# batch-008 — amends edge regeneration (post-N1/N2 census fix): impact analysis (prepare only)

Edge count: **150 (current) → 577 (regenerated)**, Δ+427. 55 bills use the census `amended_laws_full` list, 77 fall back to the title-derived `amended_laws` prop, 9 have neither (logged, not dropped).
