/* Case ③ Law loop — batch-007 validator, re-pointed at batch-007-amends-regen.json and extended
 ...
 *
 * Checks (1-3 unchanged from validate-amends-regen-005.ts; 4-5 new, batch-007):
 ...
 *
 *   PGLITE_PATH=./.pglite-copy-law-007 npx tsx scripts/case-loops/law/validate-amends-regen-007.ts
 */
