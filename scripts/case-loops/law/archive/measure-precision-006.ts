 ...
 * edges (docs/data-analysis/case-law/payloads/batch-005-amends-regen.json), reported as a metric
...
const PAYLOAD = "docs/data-analysis/case-law/payloads/batch-005-amends-regen.json";
const OUT = "docs/data-analysis/case-law/payloads/batch-006-precision-measurement.json";
