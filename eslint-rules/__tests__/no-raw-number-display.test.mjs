/**
 * RuleTester coverage for eslint-rules/no-raw-number-display.cjs.
 *
 * Run: `node eslint-rules/__tests__/no-raw-number-display.test.mjs`
...
const rule = require("../no-raw-number-display.cjs");
