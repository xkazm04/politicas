/**
 * RuleTester coverage for eslint-rules/require-source-citation.cjs.
 *
 * Run: `node eslint-rules/__tests__/require-source-citation.test.mjs`
...
const rule = require("../require-source-citation.cjs");
