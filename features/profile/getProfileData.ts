...
import { computeScoreLegibility } from "@/lib/analysis/score-legibility";
...
export type {
  CoVoter, Rebellion, CommitteeSeat, SponsoredBill, RapporteurBill, BillEngagement, ProfileData,
  ProfileContractLine,
  ProfileMoney,
  ProfileMoneyTie,
} from "./profileTypes";
