      ...
      <header className="border-b border-hairline">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-6 py-4">
          ...
          <nav className="flex flex-wrap gap-4 font-mono text-xs uppercase tracking-widest">
            <Link href="/zebricek" className="hover:text-signal-text">
              {t("navRanking")}
            </Link>
            <Link href="/hlasovani" className="hover:text-signal-text">
              {t("navVotes")}
            </Link>
            <Link href="/penize" className="hover:text-signal-text">
              {t("navMoney")}
            </Link>
            <Link href="/zakony" className="hover:text-signal-text">
              {t("navLaws")}
            </Link>
          </nav>
        </div>
