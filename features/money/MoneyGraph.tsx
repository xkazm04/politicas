...
/**
 * Graf entit — peněžní stopa osoba → firma → veřejné peníze, přeložená
 * z archivního Rentgenu do řeči Konstrukt: papír, vlasová mřížka, uzly
 * jako ploché tvary (osoba kobalt, firma čerň, strana ocel, peníze
 * signální kosočtverec). Najetí na uzel rozsvítí jeho hrany i s popisky;
 * pás dole čte vybraný uzel jako záznam.
 */
